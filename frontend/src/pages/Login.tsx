  ...
  return (
    <div className="login-page">
      <section className="login-brand-panel">
        ...
        <div className="login-value"><p>YAPAY ZEKÂ DESTEKLİ SÖZLEŞME İNCELEME PLATFORMU</p><h1>Hukuki çalışmaları<br />daha güvenilir hale getirin.</h1><span>Kaynaklandırılmış hukuki analiz, sözleşme karşılaştırma ve merkezi hukuk bilgi tabanı tek çalışma alanında.</span></div>
